...
<body class="bg-dark bg-gradient bg-opacity-25">
    ...
    <div class="container">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li><a class="nav-link <?= isset($page_title) && $page_title == 'Categories' ? 'active' : '' ?>" href="<?= base_url('Main/categories') ?>">Categories</a></li>
            <?php endif; ?>
            <li><a class="nav-link <?= isset($page_title) && $page_title == 'Posts' ? 'active' : '' ?>" href="<?= base_url('Main/posts') ?>">Posts</a></li>
            <?php if($session->login_type == 1): ?>
